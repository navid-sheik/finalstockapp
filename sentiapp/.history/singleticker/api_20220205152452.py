...
def get_single_tweet_sentiment(request, ticker_id, sentiment_type,  record_id):
    ...
    record  =  HourlyRecord.objects.filter(pk=record_id, stock =  stock).first()

    tweet_id  =   getattr(record, sentiment_type)

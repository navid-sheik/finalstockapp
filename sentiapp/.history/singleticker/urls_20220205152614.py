...
from singleticker.api import fetchStockData, fetchStockDataHistory,getHotTweet,getSentiment24Hours,getSentimentTimeRange, getSearchTwitter,getPopularTweets,getRecentTweets, get_tweets_based_sentiment,get_single_tweet_sentiment
...
urlpatterns = [
     ...
     path('api/get_time_range_sentiment/<str:ticker_id>/<int:time_range>', getSentimentTimeRange, name="get_time_range_sentiment"),
     ...
     path('api/get_single_tweet_sentiment/<str:ticker_id>/<str:sentiment_type>/ <int:record_id>', get_single_tweet_sentiment, name="get_single_tweet_sentiment"),

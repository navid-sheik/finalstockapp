...
from singleticker.api import fetchStockData, fetchStockDataHistory,getHotTweet,getSentiment24Hours,getSentimentTimeRange, getSearchTwitter,getPopularTweets
...
urlpatterns = [
     ...
     path('api/get_popular_tweets', getPopularTweets, name="get_popular_tweets"),
